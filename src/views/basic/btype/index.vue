...
<script>
import { listBtype, delClientele } from '@/api/basic/clientele';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listBtype(this.queryParams).then((response) => {
    ...
    // 成功回调事件
    typeChanged(str) {
      this.temp = JSON.parse(JSON.stringify(str));
      // if (str) {
      //   // 刷新列表;
      //   this.getList();
      //   // this.showType = 0;
