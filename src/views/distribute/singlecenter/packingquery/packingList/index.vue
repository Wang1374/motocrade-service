            ...
            <el-row style="height: 125px; padding-top: 3px">
              ...
              <el-row style="padding-top: 10px">
                <el-col>
                  ...
                  <span class="fontSize" v-if="packingList.lclList.length > 0">
                    {{
                    packingList.lclList[0].contacts
                    }}&nbsp;&nbsp;&nbsp;&nbsp;{{
                    packingList.lclList[0].contactNumber
                    }}
                  </span>
                </el-col>
              </el-row>
        ...
        <el-col :span="18">
          <el-row style="height: 740px">
            <el-row style="height: 110px; padding-top: 3px; color: #09f">
              ...
              <el-col
                :span="12"
                style="font-size: 23px; text-align: center; padding-top: 30px"
              >Packer's Copy</el-col>
            </el-row>
            ...
            <el-row style="height: 630.2px; border: 1px solid #09f; border-left: 0">
              <el-row style="height: 65px">
                ...
                <el-col :span="13" style="padding-top: 8px; color: #09f">
                  <span>
                    &nbsp;SHIPPER'S/PACKER'S DECLARATIONS:We hereby declare that
                    the container
                    <br />&nbsp;has been thoroughly cleaned without any evidence
                    of cargoes of previous
                    <br />&nbsp;shipment prior vanning
                    and cargoes has been properly stuffed and secured.
                  </span>
                </el-col>
              </el-row>
              <el-row>
              ...
              <el-row style="height: 373px; position: relative">
                ...
                <el-row>
                  <el-col :offset="14" :span="10">
                    <span style="white-space: pre-wrap; font-weight: 900">
                      {{
                      packingList.bmRemarks
                      }}
                    </span>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :offset="14" :span="10" style="height: 50px; padding-top: 10px">
                    <span style="white-space: pre-wrap; font-weight: 900">
                      {{
                      doorRemark
                      }}
