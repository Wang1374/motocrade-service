  ...
  <div style="margin-right: 40px">
    <el-form ref="form" :model="form" :rules="rules">
      ...
      <el-row style="margin-top: 10px" class="bt">
        <el-button type="primary" @click="submitOrder" :disabled="btImOrderabled">提 交 订 单</el-button>
      </el-row>
  ...
  data() {
    return {
      ...
      validRules: {
        ...
        caseNumber: [
          { required: true, message: '箱号必须填写', trigger: 'change' }
        ]
      }
    };
  },
              ...
              if (this.blNoArray[this.blNoArray.length - 1].blNo == '') {
                ...
                for (var i = 0; i < this.makingList.length - 1; i++) {
                  for (var j = i + 1; j < this.makingList.length; j++) {
                    ...
                    if (
                      this.makingList[i].caseNumber ===
                      this.makingList[j].caseNumber
                    ) {
