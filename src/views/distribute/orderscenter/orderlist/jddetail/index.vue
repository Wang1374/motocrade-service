<template>
  ...
  >
    <el-row :gutter="20">
      <el-row style="padding-left: 15px;padding-bottom: 15px;">
        ...
        <el-col :span="4">
          ...
          <span
            :style="{ color: temp.orderStatus == 3 ? 'red' : temp.orderStatus == 2 ? 'green' : 'orange' }"
    ...
    <div slot="footer" class="dialog-footer" style="text-align: center;">
      ...
      <el-button type="primary" @click="confirmOrder">确定接单</el-button>
    </div>
...
import { orderReceiving } from '@/api/distribute/businessCenter';
...
export default {
  ...
  methods: {
    ...
    confirmOrder() {
      ...
      data.operator = this.userInfo.name;
      data.makingChestCenterList = this.mcData;
      orderReceiving(data).then((response) => {
