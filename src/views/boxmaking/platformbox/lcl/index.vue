            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="门点简称:">
                  <el-input v-model="data.door" readonly size="mini" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="门点地址:">
                  <el-input v-model="data.address" readonly size="mini" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="门点备注:">
                  <el-input v-model="data.remark" readonly size="mini" maxlength="50" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
