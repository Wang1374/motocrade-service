          ...
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button
                ...
                size="mini"
                @click="handleAdd"
                v-hasPermi="['oms:shippingexport:add']"
              >新增</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button
            ...
            <el-col :span="1.5">
              <el-button
                ...
                @click="exportList"
                plain
                v-hasPermi="['oms:shippingexport:export']"
              >导出箱货清单</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  v-hasPermi="['oms:shippingexport:edit']"
                >编辑</el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  methods: {
    ...
    getList() {
      ...
      listBusinessOrder(this.queryParams).then((response) => {
        ...
        this.$nextTick(() => {
          this.$refs.shippingexportTable.doLayout();
        });
        this.loading = false;
      });
    },
